...
class Card extends PositionComponent with DragCallbacks {
  ...
  static final RRect cardRRect = RRect.fromRectAndRadius(
    GameConstant.cardSize.toRect(),
    const Radius.circular(GameConstant.cardRadius),
  );
  static final RRect backRRectInner = cardRRect.deflate(40);
  static final Sprite flameSprite = spriteReader(1367, 6, 357, 501);
  ...
  static final Sprite redJack = spriteReader(81, 565, 562, 488);
  static final Sprite redQueen = spriteReader(717, 541, 486, 515);
  static final Sprite redKing = spriteReader(1305, 532, 407, 549);
  static final Sprite blackJack = spriteReader(81, 565, 562, 488)
    ..paint = blueFilter;
  static final Sprite blackQueen = spriteReader(717, 541, 486, 515)
    ..paint = blueFilter;
  static final Sprite blackKing = spriteReader(1305, 532, 407, 549)
    ..paint = blueFilter;
