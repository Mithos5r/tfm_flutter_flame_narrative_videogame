...
class TableauPile extends PositionComponent implements Pile {
  TableauPile({super.position}) : super(size: GameConstant.cardSize);

  /// Which cards are currently placed onto this pile.

  final List<Card> _cards = [];

  final Vector2 _fanOffset1 = Vector2(0, GameConstant.cardHeight * 0.05);

  final Vector2 _fanOffset2 = Vector2(0, GameConstant.cardHeight * 0.20);
  ...
  void layOutCards() {
    ...
    height = GameConstant.cardHeight * 1.5 + _cards.last.y - _cards.first.y;
  }
